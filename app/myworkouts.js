...
import ModalWorkoutInfo from "../components/ModalWorkoutInfo";
  ...
  return (
    <SafeAreaView  style={styles.container}>
        <View style={styles.welcomeContainer}>
            <View style={styles.pageTopInfoContainer}>
                ...
                <View style={styles.pageTopInfoTitleContainer}>
                    <Text style={styles.pageTopInfoTitle}>Meus Treinos</Text>
                </View>
            </View>
        ...
        <View style={styles.closestActivity}>
         ...
         <View style={styles.closestActivity}>
            <Text style={styles.closestTitle}>Histórico de treinos</Text>

            <WorkoutInfo 
              onPress={onMoreInfoClick}
              date="20 de mar 14:30"
              place="Sala B"
              instructor="Fulano"
              type="Treino Cardio"
            />
        ...
        <ModalWorkoutInfo isVisible={isWorkoutModalVisible} onClose={onMoreInfoModalClose} />
